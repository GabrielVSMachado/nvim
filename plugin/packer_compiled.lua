...
_G.packer_plugins = {
  catppuccin = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/opt/catppuccin",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'catppuccin'}, { event = "VimEnter *" }, _G.packer_plugins)]]
